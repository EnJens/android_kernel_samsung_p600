...
static struct gpio_init_data __initdata init_gpio_table[] = {
	...
	{ EXYNOS5420_GPX0(5), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* HOME_KEY */
 #if defined(CONFIG_N1A_WIFI)
    ...
    /* GPY 7 */
	{ EXYNOS5420_GPY7(5), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_DOWN }, /* NC */
	/* GPZ */
#if 0
...
static struct gpio_sleep_data sleep_gpio_table_default[] = {
	...
	{ EXYNOS5420_GPY7(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
